  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        exit={{ opacity: 0, y: 20 }}
        onClick={scrollToTop}
        className="fixed bottom-16 right-2 z-50 group"
      ...
      >
        <div className="relative">
          ...
          <div className="relative bg-black p-3 md:p-4 rounded-full border border-red-500 shadow-[0_0_15px_rgba(220,38,38,0.5)] group-hover:shadow-[0_0_25px_rgba(220,38,38,0.7)] transition-all duration-300">
